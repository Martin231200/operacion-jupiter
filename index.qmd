...
Usa los menús **Python**, **R** y **Julia** para entrar a cada tutorial (dividido en mini-secciones), o **Tutoriales** para ejercicios comparativos y un quiz interactivo. Las secciones **Libros** y **Semblanza de los profesores** están en construcción.

## Cómo se arma el sitio

![](images/flujo-proyecto.svg)

Cada lenguaje se escribe como notebook o página, y Quarto arma automáticamente el sitio publicado en GitHub Pages.
